...
export async function createCertification(data: CertificationFormData): Promise<CertificationWithDepartment> {
...
export async function updateCertification(id: number, data: CertificationFormData): Promise<CertificationWithDepartment> {
  const departmentId = await getDepartmentIdByType(data.department)
