...
const mockCertificationUpdate = mockPrisma.certification
  .update as jest.MockedFunction<typeof prisma.certification.update>;
      ...
      expect(mockNextResponse.json).toHaveBeenCalledWith(
        {
          ...
          message: null,
          error:
            "Missing required fields: departmentId, shortName, organization",
        },
        { status: 400 }
      );
    });
