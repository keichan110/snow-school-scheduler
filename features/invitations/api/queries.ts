...
import { fetchInvitations } from '@/app/invitations/api';
import type { InvitationTokenWithStats } from '@/app/invitations/types';
...
type InvitationsQueryOptions<TData> = Omit<
  UseSuspenseQueryOptions<InvitationTokenWithStats[], Error, TData, InvitationsQueryKey>,
...
export function useInvitationsQuery<TData = InvitationTokenWithStats[]>(
  ...
  return useSuspenseQuery<InvitationTokenWithStats[], Error, TData, InvitationsQueryKey>({
